...
$admin = Login 'admin@skyline.local'; $adminHeaders = @{ Authorization = "Bearer $($admin.accessToken)" }
...
$finance = Login 'finance@skyline.local'; $financeHeaders = @{ Authorization = "Bearer $($finance.accessToken)" }
